...
<body>
	<div style="background:#FFFFFF; height:600px;">
		<div id="cont">
			<div id="cont_main">
				<div id="cont_main_l"><img src="<%=path%>/images/icon_failed.png" /></div>
				<div id="cont_main_r">
					<span class="a">操作失败！！${message.msgString}</span><br />
					<span>提示你可以进行以下操作：<a href="javascript:window.history.go(-2);">返回上一页</a>					
				</div>
			</div>
		</div>
	</div>
