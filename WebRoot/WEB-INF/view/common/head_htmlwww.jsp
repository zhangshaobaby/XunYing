...
<c:set var="tt" value="http://www.1717tou.com"/>
	<script>
	...
	<div class="newtop" style="margin:0 auto;">
			...
			<div class="newtop1_main">
				...
				<c:choose>
					<c:when test="${sessionScope.user==null}">
						<a href="https://www.1717tou.com/dologin">登陆</a>&nbsp;&nbsp;
						<a href="https://www.1717tou.com/user/register">注册</a>&nbsp;&nbsp;
					</c:when>
					<c:otherwise>
					欢迎你，<span class = "welcomeAhref" ><a href="${tt}/user/userCenter"><span>${sessionScope.user.username}</span></a></span>!
								&nbsp;&nbsp;
								<a href="https://www.1717tou.com/outLogin">退出</a>&nbsp;&nbsp;
					</c:otherwise>
				</c:choose>
		        <a href="http://download.1717tou.com/"><img src="${ctx}/images/icon_03.png" alt="">手机登陆</a>&nbsp;&nbsp;
				<a href="${tt}/user/userCenter">个人中心</a>&nbsp;&nbsp;
				<a href="${tt}/user/userCenter?message">&nbsp;&nbsp;
		...
		<div class="newtop2">
			<div class="newtop2_l"><a href="${tt }/index"><img src="${ctx }/images/logo.png"></a></div>
			<div class="newtop2_c">
				<ul>
					<li>&nbsp;&nbsp;<a href="${tt }/index" style="color:#353131;font-size:14px;">首&nbsp;&nbsp;页</a></li>
					<li><a target="_blank" href="${tt }/paradise" style="color:#353131;font-size:14px;">屌丝币乐园</a></li>
					<li><a target="_blank" href="${tt }/huodong/newinfor" style="color:#353131;font-size:14px;">新手指引</a></li>
					<li><a target="_blank" href="${tt }/huodong/anquaninfor" style="color:#353131;font-size:14px;">安全保障</a></li>
					<li><a target="_blank" href="${tt }/huodong/about" style="color:#353131;font-size:14px;">关于我们</a></li>
					<li><a target="_blank" href="${tt}/project/list"><img src="${ctx }/images/touzi.png" /></a></li>
