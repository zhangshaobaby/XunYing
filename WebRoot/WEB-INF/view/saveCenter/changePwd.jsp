					...
					<div class="user_cont_r_2">
						<div class="user_cont_r_2b">
							...
							<div class="user_cont_r_2b1">
								...
								<div class="user_cont_r_2b1c">启用密保问题即可修改</div>
								<div class="user_cont_r_2b1d"></div>
							</div>
						<!-- 内容开始 -->
							<div class="user_cont_r_2b_pass">
								<div class="user_cont_r_2b_pass1">
								<form name="form_anquan3" method="post" action="<%=path%>/user/changePwd" id="form_changePwd">
									...
									<div class="user_cont_r_2b_pass1_main">
										<div class="user_cont_r_2b_pass1_main1">
											...
											<div class="user_cont_r_2b_pass1_main1_r1">请定期修改密码，6-16个字符，建议使用字母加数字或符号的组合密码</div>
										</div>
										
										<div class="user_cont_r_2b_pass1_main1">
											<div class="user_cont_r_2b_pass1_main1_l">当前密码</div>
											<div class="user_cont_r_2b_pass1_main1_c"><input type="password"  id="password" name="pwd" /></div>
