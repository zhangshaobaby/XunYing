...
<div class="feat-area">
	...
	<!-- 首页内容1开始 -->
			...
			<div class="product_cont">				
				<div class="product_cont2">
					<div class="product_cont2_menu">
						<ul>
						    <li onmouseover="changestyle(this.id)" id="td1" class="product_cont2_menu2"><a href="${ctx }/project/list?type=0"><img class="img1" src="${ctx }/images/indexgai3.png"/></a></li>
							<li onmouseover="changestyle(this.id)" id="td2"><a href="${ctx }/project/list?type=2"><img class="img2" src="${ctx }/images/indexgai4.png"/></a></li>
							<li onmouseover="changestyle(this.id)" id="td3"><a href="${ctx }/project/list?type=1"><img class="img3" src="${ctx }/images/indexgai5.png"/></a></li>
							<li onmouseover="changestyle(this.id)" id="td4"><a href="${ctx }/project/list?type=3"><img class="img4" src="${ctx }/images/indexgai5_2.png"/></a></li>
						</ul>
					</div>
					<!-- start -->
					<div class="product_cont2_cont" id="product_cont2_content"></div>
					<div class="product_cont2_nocont ying" id="product_cont2_cont_td1">
				       <div class="product_cont2_nocont_a1">
							<span style="margin-left:30px;">更高安全、更高收益的“无忧理财”</span>
							<span><a href="${ctx }/project/list?type=0" style="color:#ffffff">更多>></a></span>
							<div style="clear:both;"></div>
                       </div>
                       
						<div class="list1">
							<c:forEach items="${pList1}" var="p" varStatus="index">
								<div class="list1_1">
								  <div class="top">
								  	<c:choose>
								  ...
								  <div class="con2">
									<input class="knob" data-height="74" data-width="74" data-fgColor="#ea4c59" data-thickness=".15" data-readOnly=true value="${p.flag}" data-min="0" data-max="100.01" style="display:none; width:0px;visibility:hidden;"/>
							  		...
							  		<a href="${ctx }/project/view?id=${p.id }">
									   <c:choose>
									   		<c:when test="${p.create_username==1}">
												<img src="${ctx }/images/indexgai8_1.png" alt=""/>
									   		</c:when>
											<c:when test="${p.flag!=100&&p.state==0&&p.rate_type==1}">
												<img src="${ctx }/images/indexgai8.png" alt=""/>
											</c:when>
					...
					<div class="product_cont2_nocont" id="product_cont2_cont_td2">
						<div class="jin_product_cont2_nocont_a1">
                         <span style="margin-left:30px;">强化风控，更高一级的投资决策选择</span>
                         <span><a href="${ctx }/project/list?type=2" style="color:#ffffff">更多>></a></span>
                        </div>
						<div class="list1">
					...
					<div class="product_cont2_nocont" id="product_cont2_cont_td3">
						<div class="zi_product_cont2_nocont_a1 ">
							<span style="margin-left:30px;">投资多样化，更多的选择</span>
							<span><a href="${ctx }/project/list?type=1" style="color:#ffffff">更多>></a></span>
						</div>
						<div class="list1">
							<c:forEach items="${pList2}" var="p" varStatus="index">
								<div class="list1_1">
								  <div class="top">
								  	<c:choose>
								  		<c:when test="${p.code!=null&&p.code!=''}">
								  ...
								  <div class="con2">
								  	<input class="knob" data-height="74" data-width="74" data-fgColor="#319DD0" data-thickness=".15" data-readOnly=true value="${p.flag}" data-min="0" data-max="100.01" style="display:none; width:0px;visibility:hidden;"/>
									<div class="percentText">${p.flag}%</div>
								  </div>
								  <div class="con3">
								  	<table cellspacing="0">
								  ...
								  <div class="con4">
							  		...
							  		<a href="${ctx }/project/view?id=${p.id }">
									   <c:choose>
									   		<c:when test="${p.create_username==1}">
												<img src="${ctx }/images/indexgai8_7.png" alt=""/>
									   		</c:when>
											<c:when test="${p.flag!=100&&p.state==0&&p.rate_type==1}">
												<img src="${ctx }/images/indexgai8_6.png" alt=""/>
											</c:when>
											<c:when test="${p.flag==100&&p.state==0}">
												<img src="${ctx }/images/p4.png" alt=""/>
											</c:when>
				...
				<!--屌丝宝tab开始-->
                    <div class="product_cont2_nocont" id="product_cont2_cont_td4">
						<div class="diao_product_cont2_nocont_a1 ">
                        	<span style="margin-left:30px;">预期收益 8%-11%；随存随取，安全放心；限量发行，先到先得</span><span><a style="color:#ffffff" href="${ctx }/project/list?type=3">更多>></a>
                        </div>
                        <div class="list2">
		...
		<div class="zi_zhan">
			<img src="${ctx }/images/indexgai5.png" />
	        <div class="zi_product_cont2_nocont_a1 ">
				<span style="margin-left:30px;">投资多样化，更多的选择</span><span><a href="${ctx }/project/list?type=1" style="color:#ffffff">更多>></a></span>
	        </div>
			<div class="list1">
				<c:forEach items="${pList2}" var="p" varStatus="index">
						<div class="list1_1">
		...
		<div class="zi_zhan">
			<img src="images/indexgai5_3.png" />
	   		<div class="diao_product_cont2_nocont_a1 " >
	         <span style="margin-left:30px;">预期收益 8%-11%；随存随取，安全放心；限量发行，先到先得</span><span><a href="${ctx }/project/list?type=3" style="color:#ffffff">更多>></a>
	        </div>
	        <div class="list2">
	        	<c:forEach items="${pList4}" var="p" varStatus="index">
                        	<div class="list1_bao">
		...
		<div class="main6_1">
			<table cellspacing="0">
				...
				<tr>
					...
					<td class="m1"><img src="${ctx}/images/index_b1.png" alt="" /><img src="${ctx}/images/index_b2.png" alt="" /></td>
