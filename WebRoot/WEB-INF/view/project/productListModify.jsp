...
<body>
	<form action="${ctx }/auth/project/productListModify" method="post" id="pageForm">
	...
	<div style="background:#FFFFFF;">
		...
		<a href="${ctx }/auth/project/toAddPre"><img src="${ctx}/images/button_add.png" /></a>
		</div>
		<div class="admincp_r2">
			...
			<div class="admincp_r2_main">
				...
				<div class="admincp_r2_main3">
					<c:choose>
						<c:when test="${_project.state == -1 || _project.state == -2}">
							<a href="${ctx }/auth/project/toAddPre?id=${_project.id }">
			    				修改
			    			</a>
							<a href="${ctx }/project/view?id=${_project.id }" target="_blank">
			    				预览
			    			</a>
						</c:when>
						<c:otherwise>
