...
function loadSelect(obj){
	...
	var iDiv = document.createElement("div");
		...
		iDiv.style.background="#FFFFFF url(images/icon_select.png) no-repeat right";
		//iDiv.style.background="#FFFFFF";

		iDiv.style.border="1px solid #999999";
	...
	iDiv.onclick=function(){//鼠标点击
		...
		//判断是否创建过div
			...
			cDiv.style.height=obj.options.length *30 + "px";
			...
			for (var i=0;i<obj.options.length;i++){
				...
				lLi.style.height="30px";
				lLi.style.lineHeight="30px";
