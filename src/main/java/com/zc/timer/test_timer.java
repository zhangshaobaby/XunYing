...
import com.zc.base.util.task.ICountDictJob;
...
public class test_timer {
    ...
    */
	...
	@Autowired
	public ICountDictJob countDictJob;
	/**
    *  Function:取得汇付对账数据
    *  @author ly
    */
	//@Scheduled(fixedDelay = 5000)   //5秒更新一次
   @Scheduled(cron = " 0 0 02 * * ?")  //每天晚上2点秒执行更新
...
//    */
//	//@Scheduled(fixedDelay = 5000)   //5秒更新一次
//   @Scheduled(cron = "0 0/60 * * * ?")  //每天每隔半小时更新一次
//   public void doTotal(){
//	   try {
//		   this.countDictJob.dojob();
//	} catch (Exception e) {
//		e.printStackTrace();
//	}
//      
