 ...
 *
 */
public class TrfReconciliationReturn {
	...
	private List<ReconciliationDtoResult>ReconciliationDtoList;
	...
	public List<ReconciliationDtoResult> getReconciliationDtoList() {
		return ReconciliationDtoList;
	}
	public void setReconciliationDtoList(
			List<ReconciliationDtoResult> reconciliationDtoList) {
