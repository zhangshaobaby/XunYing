...
public class FssTransReturn {
	...
	private String checkCode = "CmdId + RespCode + MerCustId + UsrCustId + OrdId + OrdDate + TransType + TransAmt + RetUrl + BgRetUrl + MerPriv + RespExt + ";
