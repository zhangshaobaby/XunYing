...
public class CashAuditReturn {
	...
	private String checkCode = "CmdId + RespCode + MerCustId + OrdId + UsrCustId + TransAmt + OpenAcctId + OpenBankId + AuditFlag + RetUrl + BgRetUrl + MerPriv + ";
