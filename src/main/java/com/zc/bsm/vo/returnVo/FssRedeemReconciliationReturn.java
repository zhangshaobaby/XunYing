...
public class FssRedeemReconciliationReturn {
	...
	private List<FssRedeemReconciliationResult> FssReconciliationList;
	...
	public List<FssRedeemReconciliationResult> getFssReconciliationList() {
		return FssReconciliationList;
	}

	public void setFssReconciliationList(
			List<FssRedeemReconciliationResult> fssReconciliationList) {
