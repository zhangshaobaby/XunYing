...
public class TenderCancleReturn {
...
return TransSubmit.validate(this,this.getClass());
	...
	private String checkCode = "CmdId + RespCode + MerCustId + OrdId + OrdDate + TransAmt + UsrCustId + IsUnFreeze + UnFreezeOrdId + FreezeTrxId + RetUrl + BgRetUrl + MerPriv + RespExt + ";
