...
<div class="mid1">2.2	乙方自愿将与本协议第三条所述“认购金额”等值的资金，委托甲方以甲方指定的第三方的名义购买约定的理财或<br/>&nbsp;&nbsp;投资产品；甲方同意接受乙方的委托，以甲方指定的第三方的名义购买约定的理财或投资产品。</div>
...
<div class="mid1_1">4.1.1	乙方点击“确认投资”按钮确认后，即视为乙方已经向甲方发出不可撤销的授权指令，授权甲方委托相应的第<br/>&nbsp;&nbsp;&nbsp;三方支付机构，冻结一定数额的资金。</div>
...
<div class="mid1_1">4.2.1	在认购期限届满当日，该理财或投资产品认购份数或认购金额未达到最低认购份数/认购金额的，或因其他原因<br/>&nbsp;&nbsp;&nbsp;导致理财或产品未购买成功的，视为流标。</div>
...
4.3.2	满标后，甲方可划转监管资金中与“认购金额”等值的资金，用于以甲方指定的第三方的名义购买约定的理财<br/>&nbsp;&nbsp;&nbsp;或投资产品，并以甲方指定的第三方的名义签署相关协议。<br/>
...
<div class="mid1">5.1		乙方委托甲方以甲方指定的第三方的名义购买理财或投资产品后，理财或投资产品提供方定期返还的收益（扣除<br/>&nbsp;&nbsp;费用后）将作为理财或投资产品的收益返还给乙方。</div>
<div class="mid1">5.2		乙方全权委托甲方或甲方指定的第三方对理财或投资产品所得收益进行管理，并按期返还乙方。</div>
<div class="mid1">5.3		甲方不向乙方承诺保证该收益的实现。若该理财或投资产品发生收益的，甲方应向乙方披露真实信息并按本协议<br/>&nbsp;&nbsp;约定返回乙方；若该理财或投资产品未产生收益的，则甲方无须向乙方返还收益。
</div>
...
<div class="mid1">7.2		乙方基于对甲方的信任，自愿委托甲方持有并保管本合同项下的理财或投资产品购买合同及其他相关文件。</div>				
</div>
<div class="ser_con1">
<div class="title">第八条	违约责任</div>
<div class="mid1">8.1		任何一方违反本协议的约定，视为该方违约。违约方应向对方赔偿因其违约行为而遭受的直接损失。</div>
<div class="mid1">8.2		甲方的违约责任：除前述违约赔偿一般原则以外，甲方应赔偿乙方因以下事项而遭受的全部损失（包括但不限于<br/>&nbsp;&nbsp;律师费、诉讼费、交通费等）：</div>
<div class="mid1_1">(1)	与第三方恶意串通，损害乙方利益的；<br/>
(2)	未按约定进行代理行为，或利用资金从事违法行为，导致乙方利益遭受损失的；<br/>
(3)	怠于行使理财或投资产品认购合同约定的权利，给乙方带来损失的；<br/>
(4)	违反协议约定的其他行为。<br/>
</div>
<div class="mid1">8.3		乙方的违约责任除前述违约赔偿一般原则以外，乙方应赔偿甲方因以下事项而遭受的全部损失（包括但不限于律<br/>&nbsp;&nbsp;师费、诉讼费、交通费等）：</div>
...
<div class="mid1">10.1		甲方不就理财或投资产品做保本和最低收益承诺，甲方提醒乙方理财或投资产品具有一定的投资风险，乙方应当<br/>&nbsp;&nbsp;根据自身风险承受能力，谨慎识别、评估、选择相关理财或投资产品。</div>
<div class="mid1">10.2		甲方提醒乙方宏观经济运行、国家政策、证券市场监管政策等的变化，均可能导致市场价格波动，从而影响理财<br/>&nbsp;&nbsp;或投资产品的收益。</div>
<div class="mid1">10.3		甲方提醒乙方理财或投资产品提供方受经验、技能等因素的限制，可能会影响该理财或投资产品项目管理，导致<br/>&nbsp;&nbsp;理财或投资产品资产遭受损失。</div>
<div class="mid1">10.4		流动性风险：乙方投资于本项理财或投资产品，在约定的到期日前，不能提前赎回该理财或投资产品，对于因此<br/>&nbsp;&nbsp;可能导致的资金不能及时回笼的情形，乙方须充分认知并合理安排自身资金。</div>
<div class="mid1">
